;;; black-emacs.el --- a minimal GNU/Emacs configuration
;;; -------------------------------------------------------------------
...
;; ─────────────────── font & frame size ─────────────────
(set-face-font 'default "JetBrainsMono 14")
...
(fringe-mode '(0 . 0))
(defface fallback '((t :family "JetBrainsMono"
...
can be realized (e.g.) by setting an intense background
...
secondary information and also replace italic."
:group 'black)
...
(set-fontset-font "fontset-default"  '(#x2600 . #x26ff) "JetBrainsMono 16")
